...
```mermaid
graph TD
  fc2c1d89["ERC-721 NFT"]
  1dafd213["Frontend"]
  2b8594a5["Wallet Auth"]
  fc2c1d89 --> 1dafd213
  1dafd213 --> 2b8594a5
```
...
1. **ERC-721 NFT** (`erc721-stylus`) — see `.nskills/components/erc721-stylus--fc2c1d89.md`
2. **Frontend** (`frontend-scaffold`) — see `.nskills/components/frontend-scaffold--1dafd213.md`
3. **Wallet Auth** (`wallet-auth`) — see `.nskills/components/wallet-auth--2b8594a5.md`
...
- [ERC-721 NFT](.nskills/components/erc721-stylus--fc2c1d89.md)
- [Frontend](.nskills/components/frontend-scaffold--1dafd213.md)
- [Wallet Auth](.nskills/components/wallet-auth--2b8594a5.md)
